...
double fun_Chinnery(double (*fun)(double , double ),double x,double y);
...
// mu/(lambda+mu)
  ...
  if (U1 != 0) {
    if (flag_xy) {
      U1x = -U1 / 2 / 3.14159265358979 * fun_Chinnery(f_ssUx,x,y);
      if (fabs(U1x) > 1000) 
        U1x = 0;
      U1y = -U1 / 2 / 3.14159265358979 * fun_Chinnery(f_ssUy,x,y);
      if (fabs(U1y) > 1000) 
        U1y = 0;
    }
    U1z = -U1 / 2 / 3.14159265358979 * fun_Chinnery(f_ssUz,x,y);
    if (fabs(U1z) > 1000) 
      U1z = 0;
  }
  if (U2 != 0) {
    if (flag_xy) {
      U2x = -U2 / 2 / 3.14159265358979 * fun_Chinnery(f_dsUx,x,y);
      if (fabs(U2x) > 1000) 
        U2x = 0;
      U2y = -U2 / 2 / 3.14159265358979 * fun_Chinnery(f_dsUy,x,y);
      if (fabs(U2y) > 1000) 
        U2y = 0;
    }
    U2z = -U2 / 2 / 3.14159265358979 * fun_Chinnery(f_dsUz,x,y);
    if (fabs(U2z) > 1000) 
      U2z = 0;
  }
   *Ux = U1x + U2x;
