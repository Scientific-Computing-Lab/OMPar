...
static const double sqrt_2pi = 2.506628274631000502415765284811045253006;
////////////////////////////////////////////////////////////////////////////////
// double xFresnel_Auxiliary_Sine_Integral( double x )                   //
//                                                                            //
//  Description:                                                              //
...
double xFresnel_Auxiliary_Sine_Integral(double x)
{
  if (x == 0.0) 
    return 0.5;
  if (x <= 1.0) 
    return Chebyshev_Expansion_0_1(x);
  if (x <= 3.0) 
    return Chebyshev_Expansion_1_3(x);
  if (x <= 5.0) 
    return Chebyshev_Expansion_3_5(x);
  if (x <= 7.0) 
    return Chebyshev_Expansion_5_7(x);
...
static double Chebyshev_Expansion_0_1(double x)
{
  static const double c[] = {(+2.560134650043040830997e-1), (- 1.993005146464943284549e-1), (+4.025503636721387266117e-2), (- 4.459600454502960250729e-3), (+6.447097305145147224459e-5), (+7.544218493763717599380e-5), (- 1.580422720690700333493e-5), (+1.755845848573471891519e-6), (- 9.289769688468301734718e-8), (- 5.624033192624251079833e-9), (+1.854740406702369495830e-9), (- 2.174644768724492443378e-10), (+1.392899828133395918767e-11), (- 6.989216003725983789869e-14), (- 9.959396121060010838331e-14), (+1.312085140393647257714e-14), (- 9.240470383522792593305e-16), (+2.472168944148817385152e-17), (+2.834615576069400293894e-18), (- 4.650983461314449088349e-19), (+3.544083040732391556797e-20)};
...
static double Chebyshev_Expansion_5_7(double x)
{
  static const double c[] = {(+1.000801217561417083840e-3), (- 4.915205279689293180607e-4), (+8.133163567827942356534e-5), (- 1.120758739236976144656e-5), (+1.384441872281356422699e-6), (- 1.586485067224130537823e-7), (+1.717840749804993618997e-8), (- 1.776373217323590289701e-9), (+1.765399783094380160549e-10), (- 1.692470022450343343158e-11), (+1.568238301528778401489e-12), (- 1.405356860742769958771e-13), (+1.217377701691787512346e-14), (- 1.017697418261094517680e-15), (+8.186068056719295045596e-17), (- 6.305153620995673221364e-18), (+4.614110100197028845266e-19), (- 3.165914620159266813849e-20), (+1.986716456911232767045e-21), (- 1.078418278174434671506e-22), (+4.255983404468350776788e-24)};
  static const int degree = (sizeof(c) / sizeof(double ) - 1);
...
static double Asymptotic_Series(double x)
{
  ...
  double g = 0.0;
  double term[36];
  double epsilon = ((double )2.22044604925031308084726333618164062e-16L) / 4.0;
  int j = 5;
  int i = 0;
  term[0] = 1.0;
  term[35] = 0.0;
